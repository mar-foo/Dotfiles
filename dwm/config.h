...
static const char *unicode[]  = {"dmenuunicode", NULL};
static const char *lowervol[] = {"amixer", "sset", "Master", "5%-", NULL};
static const char *raisevol[] = {"amixer", "sset", "Master", "5%+", NULL};
static const char *mixer[]    = {"st", "-e", "alsamixer", NULL};
static const char *lock[]     = {"slock", NULL};
static const char *music[]    = {"cmus_open.sh", NULL};
