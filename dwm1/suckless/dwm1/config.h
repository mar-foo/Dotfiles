...
//static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-l", "15", "-g", "3", "-c", NULL };
//static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-l", "15", "-g", "3", "-c", NULL };
static const char *dmenucmd[] = { "/home/mario/.local/bin/scripts/dmen.sh", NULL }; //Dmenu pywal colors
