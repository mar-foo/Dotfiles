...
case "$@" in
	...
	hc keyunbind Mod4-Mod1-s
	hc keybind Mod4-Mod1-s spawn ~/.local/bin/scripts/sticky.sh unstick
        notify-send -u normal "Sticky" "Window is <b><span foreground=\"#c0f83e\">STICKY</span></b>"
        ;;
    unstick)
        hc set_attr my_sticky ''
	hc keyunbind Mod4-Mod1-s
	hc keybind Mod4-Mod1-s spawn ~/.local/bin/scripts/sticky.sh stick
